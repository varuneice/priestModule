...
class FoodcouponModel extends AppModel {
    ...
    var $schema = array(
        ...
        array('name' => 'Name_Authorized', 'type' => 'varchar', 'default' => ':NULL'),
         ...
         array('name' => 'PujaType', 'type' => 'varchar', 'default' => ':NULL'),
         array('name' => 'filename', 'type' => 'varchar', 'default' => ':NULL'),
         array('name' => 'Parents', 'type' => 'varchar', 'default' => ':NULL'),
    ...
    public function saraswati($opts)
    {
        $sql = 'SELECT * FROM '.$this->getTable().' WHERE PujaType ="'."saraswati".'" ';
        $result = array();
        $arr = $this->execute($sql);
        return $arr;
    ...
    public function kali($opts)
    {
        $sql = 'SELECT * FROM '.$this->getTable().' WHERE PujaType ="'."kali".'"';
        $result = array();
        $arr = $this->execute($sql);
        return $arr;
