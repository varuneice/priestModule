                ...
                if (($_POST['PaymentOption'] ?? '') == 'stripe') {
                    ...
                    ?>
                     <table border="4" width='585px' style= "margin-left:30em;" >
                                ...
                                <tr>
                                <tr><td>Order ID</td> <td><?php echo $tpl['arr']['oid'] ?? ''; ?></td></tr>
                                  <tr><td>Member Id</td> 
                                            <td><?php echo $tpl['arr']['Member_id'] ?? ''; ?></td>
                                            </tr>
                                <tr><td>Name</td> <td><?php echo $tpl['arr']['MemberName'] ?? ''; ?></td></tr>
                                <tr><td>Donation Amount</td> <td><span style="color:red;">$</span><?php echo $tpl['arr']['Amount'] ?? ''; ?></td></tr>
                        ...
                        <?php echo "<a href='" . INSTALL_URL . "Donations/GiftShop'>Go to home</a>";?> 
            ...
            <main role="main">
                <div class="logo" style="background-color: #357ca5;">
                    ...
                    <h3><b>Houston Durga Bari Society</b></h3>
                      ...
                      <h1 class="logo-caption"><span class="tweak">G</span>ift <span class="tweak">S</span>hop & <span class="tweak">M</span>isc</h1>
                </div> 
                <!-- logo class -->
...
<td class="td" colspan="2"><select required="" name="paymentfor" id="paymentfor"
...
<tr class="tr">
    <td class="td" >Durga Bari Member</td>
             ...
             <tr class="tr">
                     ...
                     <td class="td"><input  type="number" name='demmember' id="demmember" class="form-control input-sm point" oninvalid="InvalidMsg(this);" 
...
<td class="td"> 
<input type="text"class="form-control input-sm" name="purpose" value="General" selectBoxOptions="General;" tabindex="5"> 
</td>
<td class="td"> Street No<span style="color:#ff0000">*</span></td>
<td class="td"> <input  id="Street" class="form-control input-sm" type="text" placeholder="Street No" value="" name="Street" tabindex="6" required=""></td>
</tr>

<tr class="tr">

 <td class="td">Address<span style="color:#ff0000">*</span></td> 
<td class="td"> <input  id="ressidentalAddress" class="form-control input-sm" type="text" placeholder="Address" value="" name="Address" tabindex="7" required=""></td>
<td class="td">City<span style="color:#ff0000">*</span></td>
<td class="td">  <input  id="city" class="form-control input-sm" type="text" name="City" size="25" value="" title="City" placeholder="City" tabindex="8" required=""></td>
</tr>
...
<td class="td"> <input id="zip_code" class="form-control input-sm" type="text" placeholder="Zip Code" value="" name="Zip_Code" tabindex="10" required=""></td>
 </tr>

<tr class="tr">
<td class="td"> Phone Number<span style="color:#ff0000">*</span></td>
<td class="td">  
 <input id="phone" class="form-control input-sm" type="text" required="" placeholder="###) ###-####" value="" name="Tele1"  onchange="sponsoramount(this.id)" maxlength="10" tabindex="11"> 
<!-- <input id="phone" name="phone" type="tel"> -->
</td>
<td class="td">Email<span style="color:#ff0000">*</span></td>
<td class="td"><input required="" id="email" class="form-control input-sm" type="text" placeholder="name@company.com" value="" name="email" tabindex="12" pattern="[^@\s]+@[^@\s]+\.[^@\s]+"></td>
...
<td class="td"> <input id="ltd1" class="form-control input-sm" type="text" placeholder="Lifetime Contribution" value="" name="LTC" tabindex="13" readonly></td>


<td class="td">Annual Donation</span></td>
<td class="td">  
 <input id="ytd1" class="form-control input-sm" type="text" placeholder="Annual Donation"  value="" name="YTD" tabindex="14" readonly> 
</td>
...
<td class="td">  
 <input id="MembCategory" class="form-control input-sm" type="text" placeholder="Membership Category"  value="" name="Membership Category" tabindex="15" readonly> 
</td>
...
<div class="input-group">
 ...
 <input required="" id="total" class="form-control input-sm" type="number" placeholder="$Amount" value="" name="Amount" tabindex="16" onchange="amountvalid(this.id)">
  </div>
 </div>
 </td>
...
<tr style="display:none;"> <td class="td"> <input id="Zellecode" class="form-control input-sm" type="text" name="code"> </td></tr>
                ...
                <tr class="tr">
                    ...
                    <td class="td" colspan="2">
                        <select required="" name="PaymentOption" id="PaymentOption" class="form-control input-sm"
                            aria-required="true" aria-invalid="false" style="width:100%; height:50%;" tabindex="15">
