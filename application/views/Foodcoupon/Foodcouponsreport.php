...
<section class="content">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="active">
                <a data-toggle="tab" href="#sponsortab"><?php echo __('Kali puja Report'); ?></a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#saraswatitab"><?php echo __('Saraswati Puja report'); ?></a>
            </li>
        </ul>
...
<input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>">
            ...
            <div id="saraswatitab" class="tab-pane">
                <div class="box">
                    <div class="box-body table-responsive">
                        <div id="example1_wrapper" class="dataTables_wrapper form-inline" role="grid">
                            <form name="table-frm" id="table-frm-id" method="post" action="<?php echo INSTALL_URL; ?>?controller=Badges&action=deleteSelected">
<input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>">
                                <?php
                                require 'component/saraswatireport_table.php';
                                ?>
                            </form>
                        </div>
                    </div>
