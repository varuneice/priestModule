...
<table id="<?php echo (count($tpl['foodarr'])) ? "saraswati-table-id" : ""; ?>" class="gzblog-table table-striped table-hover" cellpadding="0" cellspacing="0" >
            ...
            <td colspan="9">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo INSTALL_URL ?>Foodcoupon/saraswatiexport"><?php echo __('export'); ?></a></li>
...
<script>
$(function() {
    if ($('#saraswati-table-id').length > 0) {
            $('#saraswati-table-id').dataTable({
                "aoColumnDefs": [
