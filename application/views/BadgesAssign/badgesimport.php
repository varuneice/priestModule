<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo INSTALL_URL; ?>Badges/index"><?php echo __('Badges'); ?></a></li>
        ...
        <div class="col-md-12 ui-sortable">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form id="import-frm-id" class="frm-class import-frm-class" action="<?php echo INSTALL_URL; ?>BadgesAssign/badgesimport" method="post" name="import-frm" enctype="multipart/form-data">
<input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>">
                        <div class="callout callout-info" >
                            <h4><?php echo __('import_data') . ' ' . __('Badges'); ?></h4>
                                    ...
                                    <table class="table table-striped table-bordered dataTable no-footer" cellpadding="0" cellspacing="0" >
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($_POST['import'])) {
                                                if (!empty($tpl['badgesarr'])) {
                                                    foreach (($tpl['badgesarr'] ?? []) as $key => $value) {
                                                        ?>
                                                        <tr>
										...
										<td><input class="mini" type="text" name="Veggies[]" value="<?php echo $value[34]; ?>"></td> 
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td colspan="35"><?php echo $tpl['row_count'] ?></td>
                                                    </tr>
                                                </tfoot>
                                                <?php
                                            }
