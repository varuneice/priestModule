...
<section class="content-header">
    <h1>
        <?php echo __('edit_badges'); ?>
    </h1>
    <?php if (!$this->controller->isMember()) { ?>
    <ol class="breadcrumb">
        <li><a href="<?php echo INSTALL_URL; ?>"><i class="fa fa-dashboard"></i> <?php echo __('home'); ?></a></li>
        <li><a href="<?php echo INSTALL_URL; ?>BadgesAssign/BadgesAssign"><?php echo __('Badges'); ?></a></li>
        <li class="active"><?php echo __('edit_badges'); ?></li>
    </ol>
    <?php } ?>
</section>
<?php
require_once VIEWS_PATH . 'Layouts/admin/error_notice.php';
$allotparking = $tpl['badgesarr']['Parking_AreaAssigned'] ?? ''; 
$volunteer =  $this->controller->isBadgesVolunteer();
$badgeStatus = $tpl['badgesarr']['Status'] ?? ''; 
$stu = $tpl['badgesarr']['Student'] ?? ''; 
$datedb = $tpl['badgesarr']['Date'] ?? '';  
?>
<section class="content left width_100">
    <form id="badges-form" class="frm-class user-frm-class" action="<?php echo INSTALL_URL; ?>BadgesAssign/edit"
            ...
            <fieldset>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 stretch-card1 grid-margin1">
                        <table class="table1">
                            <tr class="tr">
                                <td style="font-size: xx-large;" class="td">Durga Puja Badge Assignment</td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-green card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h4 class="font-weight-normal mb-3" style="font-size: 21px; color:white;"><b>Sequence
                                No</b><i class="mdi  mdi-24px float-right"></i>
                                </h4>
                                ...
                                <h2 class="mb-5">
                                    <input readonly id="SeqNo" class="form-control mb-5" type="text" name="SeqNo"
                                        size="12" value="<?php echo $tpl['badgesarr']['SeqNo'] ?? ''; ?>" title="Sequence No"
                                        placeholder="Sequence No">
                                </h2>
                                <!-- <h2 class="mb-5"><?php echo $tpl['badgesarr']['SeqNo'] ?? ''; ?></h2> -->
                        ...
                        <div class="card1 bg-gradient-orange card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <b><input readonly id="Your_Name" class="form-control input-sm"
                                            ...
                                            value="<?php echo $tpl['badgesarr']['F_Name'] ?? ''; ?>" title="First Name"
                                            placeholder="First Name"></b></h2>
                                <!-- <h2 class="mb-5"><?php echo $tpl['badgesarr']['F_Name'] ?? ''; ?></h2> -->
                        ...
                        <div class="card1 bg-gradient-orange card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input readonly id="last name" class="form-control input-sm"
                                        ...
                                        value="<?php echo $tpl['badgesarr']['L_Name'] ?? ''; ?>" title="Last Name"
                        ...
                        <div class="card1 bg-gradient-orange card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input readonly id="Spouse" class="form-control input-sm" type="text"
                                        name="Sp_FName" size="25" value="<?php echo $tpl['badgesarr']['Sp_FName'] ?? ''; ?>"
                                        title="Spouse Name" placeholder="Spouse Name"></h2>
                                <!-- <h2 class="mb-5"> <?php echo $tpl['badgesarr']['Sp_FName'] ?? ''; ?></h2> -->
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"><input id="Child1" class="form-control input-sm" type="text"
                                        name="Child1" size="25" value="<?php echo $tpl['badgesarr']['Child1'] ?? ''; ?>"
                                ...
                                <h2 class="mb-5"><input readonly id="Child1" required="true"
                                        ...
                                        value="<?php echo $tpl['badgesarr']['Child1'] ?? ''; ?>" title="Child1"
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input id="Child2" class="form-control input-sm" type="text"
                                        name="Child2" size="25" value="<?php echo $tpl['badgesarr']['Child2'] ?? ''; ?>"
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input id="Child3" class="form-control input-sm" type="text"
                                        name="Child3" size="25" value="<?php echo $tpl['badgesarr']['Child3'] ?? ''; ?>"
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input id="Parent1" class="form-control input-sm" type="text"
                                        name="Parent1" size="25" value="<?php echo $tpl['badgesarr']['Parent1'] ?? ''; ?>"
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input id="Parent2" class="form-control input-sm" type="text"
                                        name="Parent2" size="25" value="<?php echo $tpl['badgesarr']['Parent2'] ?? ''; ?>"
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input id="Adult" class="form-control input-sm" type="number"
                                        name="Adult" size="25" value="<?php echo $tpl['badgesarr']['Adult'] ?? ''; ?>"
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input id="Child" class="form-control input-sm" type="number"
                                        name="Child" size="25" value="<?php echo $tpl['badgesarr']['Child'] ?? ''; ?>"
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input id="Total" class="form-control input-sm" type="number"
                                        name="Total" size="25" value="<?php echo $tpl['badgesarr']['Total'] ?? ''; ?>"
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input id="YTD" class="form-control input-sm" type="text" name="YTD"
                                        size="25" value="<?php echo $tpl['badgesarr']['YTD'] ?? ''; ?>" title="YTD "
                                ...
                                <h2 class="mb-5"> <input readonly id="YTD" class="form-control input-sm" type="text"
                                        name="YTD" size="25" value="<?php echo $tpl['badgesarr']['YTD'] ?? ''; ?>"
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                <img src="<?= INSTALL_URL ?>images/dashboard/circle.svg"
                                    class="card-img-absolute1" alt="circle-image" />
                                <h4 class="font-weight-normal mb-3" style="font-size:16px; color:white;"><b>Sponsorship
                                        </b>

                                </h4>
                                <h4 class="font-weight-normal mb-3" style="font-size:16px; color:white;"><b>
                                        Amount</b>
                                ...
                                <h2 class="mb-5"> <input id="Sponsorship_Amount" onchange="sponsoramount(this.id)"
                                        ...
                                        value="<?php echo $tpl['badgesarr']['Sponsorship_Amount'] ?? ''; ?>"
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input readonly id="Sponsor" class="form-control input-sm" type="text"
                                        name="Sponsor" size="25" value="<?php echo $tpl['badgesarr']['Sponsor'] ?? ''; ?>"
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input id="Magazines" class="form-control input-sm" type="number"
                                        name="Magazines" size="25" value="<?php echo $tpl['badgesarr']['Magazines'] ?? ''; ?>"
                                ...
                                <h2 class="mb-5"> <input readonly id="Magazines" class="form-control input-sm"
                                        ...
                                        value="<?php echo $tpl['badgesarr']['Magazines'] ?? ''; ?>" title="Magazines"
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5">
                                   <input <?php echo ($tpl['badgesarr']['Student'] == 'Yes') ? "checked='checked'" : ""; ?>
                                        type="radio" id="yes" name="Student" value="Yes">
                                    <label for="yes" style="font-size: 22px; color:white;">Yes</label>&nbsp;&nbsp;

                                    <input <?php echo ($tpl['badgesarr']['Student'] == 'No') ? "checked='checked'" : ""; ?>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <?php if ($this->controller->isBadgesAdmin() || $this->controller->isAdmin())  { ?>
                                <h2 class="mb-5"> <input  id="StudentVerified" required="true"
                                        class="form-control input-sm" type="text" name="StudentVerified" size="25"
                                        value="<?php echo $tpl['badgesarr']['StudentVerified'] ?? ''; ?>"
                                ...
                                <h2 class="mb-5"> <input readonly required="true" id="StudentVerified"
                        ...
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input id="PendingIssues" class="form-control input-sm" type="text"
                                        ...
                                        value="<?php echo $tpl['badgesarr']['PendingIssues'] ?? ''; ?>"
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                <img src="<?= INSTALL_URL ?>images/dashboard/circle.svg"
                                    class="card-img-absolute1" alt="circle-image" />
                                <h4 class="font-weight-normal mb-3" style="font-size: 18px; color:white;"><b>Total
                                        Badges </b>
                                ...
                                <?php if ($this->controller->isBadgesAdmin() || $this->controller->isAdmin())  { ?>
                                <h2 class="mb-5"> <input id="totalbadges"  class="form-control input-sm"
                                        type="number" name="total_badges" size="25"
                                        value="<?php echo $tpl['badgesarr']['total_badges'] ?? ''; ?>" title="Total Badges"
                                        placeholder="Total Badges"></h2>
                                <?php }else{ ?>
                                <h2 class="mb-5"> <input id="totalbadges" required="true" class="form-control input-sm"
                                        type="number" name="total_badges" size="25"
                                        value="<?php echo $tpl['badgesarr']['total_badges'] ?? ''; ?>" title="Total Badges"
                                        placeholder="Total Badges"></h2>
                                <?php } 
                        ...
                        <div class="card1 bg-gradient-primary1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input readonly id="MID" class="form-control input-sm" type="text"
                                        name="MID" size="25" value="<?php echo $tpl['badgesarr']['MID'] ?? ''; ?>"
                        ...
                        <div class="card1 bg-gradient-primary1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input readonly id="OID" class="form-control input-sm" type="text"
                                        name="OID" size="25" value="<?php echo $tpl['badgesarr']['OID'] ?? ''; ?>" title="OID"
                                        placeholder="OID"></h2>
                        ...
                        <div class="card1 bg-gradient-primary1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"><input class="col-lg-12 col-md-12 col-sm-12 col-xs-12"  type="date" id="date" name="Date"
                                        ...
                                        value="<?php echo $tpl['badgesarr']['Date'] ?? ''; ?>" title="Date"></h2>
                                <?php
                                } else {
                                    ?>
                                <h2 class="mb-5">
                                    <input class="col-lg-12 col-md-12 col-sm-12 col-xs-12" required="true" type="date" id="date" name="Date"
                                        max="<?php echo date('Y-m-d'); ?>"
                                        value="<?php echo $tpl['badgesarr']['Date'] ?? ''; ?>" title="Date">
                        ...
                        <div class="card1 bg-gradient-primary1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h2 class="mb-5"> <input id="Name_Authorized" class="form-control input-sm" type="text"
                                        ...
                                        value="<?php echo $tpl['badgesarr']['Name_Authorized'] ?? ''; ?>"
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-primary1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <input type="hidden" name="ID" value="<?php echo $tpl['badgesarr']['id'] ?? ''; ?>" />

                                <input type="hidden" name="MID" value="<?php echo $tpl['badgesarr']['MID'] ?? ''; ?>" />
                                <input type="hidden" name="OID" value="<?php echo $tpl['badgesarr']['OID'] ?? ''; ?>" />
                                <input type="hidden" name="Phone" value="<?php echo $tpl['badgesarr']['Phone'] ?? ''; ?>" />
                                <input type="hidden" name="Email" value="<?php echo $tpl['badgesarr']['Email'] ?? ''; ?>" />
                                <!-- <input type="hidden" name="SponsorshipCategory" value="<?php echo $tpl['badgesarr']['SponsorshipCategory'] ?? ''; ?>" /> -->
                                <div class="row">
                                    <?php if ($this->controller->isBadgesAdmin() || $this->controller->isAdmin())  { ?>

                                    <button class="col-lg-6 col-md-6 col-sm-6 col-xs-6 btn btn-primary"
                                        style="width:150px!important;height:110px;font-size:27px;" id="submits"
                                    ...
                                    ?>
                                    <button class="col-lg-6 col-md-6 col-sm-6 col-xs-6 btn btn-primary" disabled=""
                                        style="width:150px!important;height:110px;font-size:27px;" id="submit"
                                        autocomplete="off" value="<?php echo __('save'); ?>" name="submit" tabindex="9"
                                    ...
                                    <button
                                        onclick="location.href = '<?= INSTALL_URL ?>BadgesAssign/index';"
                                        class="col-lg-6 col-md-6 col-sm-6 col-xs-6 btn btn-primary"
                                        style="float:right!important;width:150px!important;height:110px;font-size:27px;"
...
function badgestatus() {
    var status = <?php echo(json_encode($badgeStatus)); ?>;
    var volunteer = <?php echo(json_encode($volunteer)); ?>;
    if (volunteer == true && status == "Badges Issued") {
