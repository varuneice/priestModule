...
<style>
 ...
 #deposit {
  ...
  #tab_4 > div:nth-child(3) > label{
   display:none ; 
} 
 #tab_4 >div:nth-child(4) > label{
   display:none ; 
} 
#deposit_type{
    display:none ; 
}
 #tab_4 >div:nth-child(5) > label{
   display:none ; 
} 
#tab_4 >div:nth-child(6) > label{
   display:none ; 
...
#tax_type{
 ...
 #tab_4 > div:nth-child(4) > div{
    border-bottom:#0000;
    display:none ;
}  
 #tab_4 > div:nth-child(2) > div
{
    border-bottom:#0000;
} 
