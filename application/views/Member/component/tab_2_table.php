        ...
        if ($count > 0) {
            for ($i = 0; $i < $count; $i++) {
                ...
                <tr class="<?php echo $i % 2 === 0 ? 'odd' : 'even'; ?>">
                    ...
                    <td><?php echo ($tpl['life'][$i]['F_Name'] ?? '') . ' ' . ($tpl['life'][$i]['M_Name'] ?? '') . ' ' . ($tpl['life'][$i]['L_Name'] ?? '');?></td>
                    <td><?php echo ($tpl['life'][$i]['Sp_FName'] ?? '').' '.($tpl['life'][$i]['Sp_LName'] ?? ''); ?></td>
                    <td><?php echo $tpl['life'][$i]['Category']; ?></td>
                    <td><?php echo $tpl['life'][$i]['Tele1']; ?></td>
                    <td><?php echo $tpl['life'][$i]['email']; ?></td>
                    <td><?php echo $tpl['life'][$i]['pay_date']; ?></td>
                     <td><?php echo $tpl['life'][$i]['oid']; ?></td>
                    <td><?php echo $tpl['life'][$i]['AMC']; ?></td>
                    <td><?php echo $tpl['life'][$i]['LTC']; ?></td>
                    <td><?php echo $tpl['life'][$i]['YTD']; ?></td>
                    <td><a class="btn btn-success btn-sm" href="<?php echo INSTALL_URL; ?>Member/adminedit/<?php echo $tpl['life'][$i]['ID']; ?>" rev="<?php echo $tpl['life'][$i]['ID']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
                    ...
                    <?php }?>
                     <?php if (!$this->controller->isAdmin() )  { ?>
                    <td><a cat="2" rev="<?php echo $tpl['life'][$i]['ID']; ?>" href=""><span></span></a></td>
                    <?php }?>
            ...
            <td colspan="9">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo INSTALL_URL ?>Member/export/LM"><?php echo __('export'); ?></a></li>
