        ...
        <row class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input id="category" class="form-control input-sm" type="text" name="Category" size="25" value="<?php echo @$_POST['Category']; ?>" title="<?php echo __('category'); ?>" placeholder="">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label class="control-label" for="email"><?php echo __('email'); ?>:</label>
                    <input id="email" class="form-control input-sm" type="text" name="Email" size="25" value="<?php echo @$_POST['Email']; ?>" title="<?php echo __('Email'); ?>" placeholder="">
                </div>
            </div>
        </row>
        <row>
