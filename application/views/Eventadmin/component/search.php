        ...
        <row class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input id="second_name" class="form-control input-sm" type="text" name="Category" size="25" value="<?php echo @$_POST['Sp_FName']; ?>" title="<?php echo __('second_name'); ?>" placeholder="">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
