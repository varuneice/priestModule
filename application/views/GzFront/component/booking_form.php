    ...
    <div class="box-body">
        ...
        <?php if ($tpl['option_arr_values']['phone'] != 1) { ?>
            <div class="form-group">
                ...
                <input id="phone" class="form-control input-sm" <?php echo ($tpl['option_arr_values']['phone'] == 3) ? "data-rule-required='true'" : ""; ?> type="text" name="phone" size="25" value="<?php echo @$_POST['phone']; ?>" title="<?php echo __('phone'); ?>"pattern="[0-9]{3}[0-9]{3}[0-9]{4}" placeholder="Phone" style="font-weight: bold;transform: translateX(-25%);">
                <div class="control-group"></div>
            </div>
        <?php } ?>
        <?php if ($tpl['option_arr_values']['email'] != 1) { ?>
            <div class="form-group">
                ...
                <input id="email" class="form-control input-sm"  <?php echo ($tpl['option_arr_values']['email'] == 3) ? "data-rule-required='true'" : ""; ?> type="email" name="email" size="25" value="<?php echo @$_POST['email']; ?>" title="<?php echo __('email'); ?>" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" placeholder="Email" style="font-weight: bold;transform: translateX(-25%);">
                <div class="control-group"></div>
            </div>
        <?php } ?>
        ...
        if ($tpl['option_arr_values']['additional'] != 1) { ?>
            <div class="form-group">
                ...
                <textarea  style="font-weight: bold;transform: translateX(-25%);" placeholder="Additional Request" <?php echo ($tpl['option_arr_values']['additional'] == 3) ? "data-rule-required='true'" : ""; ?> name="additional" class="form-control" title="<?php echo __('additional'); ?>"><?php echo @$_POST['additional']; ?></textarea>
            </div>
            <?php
        }
        if ($tpl['option_arr_values']['enable_payment'] == 1) {
            ...
            <div id="MemberID1" style="display:none;width:100%;max-width:100%;margin-top:10px;" class="form-group">
                <div class="booking-zelle-fields">
                    <label class="control-label" style="color:#555;">Zelle Payment Details:</label>
                    <div id="error_code1" style="font-size:13px;"></div>
                    <!-- Zelle transaction dropdown (populated by JS after search) -->
                    ...
                    <!-- Shown after auto-match or manual search finds results -->
                    ...
                    <div id="zelle-no-match" style="display:none;color:#c0392b;font-size:13px;margin-top:8px;padding:8px;background:#fdecea;border-radius:4px;">
                        No Zelle transaction found matching your details. Please check the name and amount, or contact admin.
                    </div>
                    <!-- Hidden fields used by existing submit logic -->
        ...
        if ($tpl['option_arr_values']['show_terms'] != 1) {
            ?>
            <div class=" height-50 text-center">
                <input id="terms" name="terms" data-rule-required='true' type="checkbox" value="1" title="<?php echo __('terms_and_conditional'); ?>" />
               <a href="javascript: void;" id="terms_link" ><?php echo __('By checking the box, the requestor (host) acknowledges that you have read, understood, and agreed to all terms outlined above in this Agreement.'); ?></a>  
            ...
            <div style="text-align: center;">
                  <div style=" font-size: 18px; color: red; ">
                    Note : Priest Dakshina Not included in Puja Prices
                 </div>
            </div>
            <?php
        }
