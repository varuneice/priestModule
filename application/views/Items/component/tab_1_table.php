...
<table id="<?php echo (count($tpl['Itemsarr'])) ? "tab-1-table-id" : ""; ?>" class="gzblog-table table-striped table-hover" cellpadding="0" cellspacing="0" >
      <?php if ( $this->controller->isAdmin())  { ?>
        <ul class="nav nav-pills">
           <li class="active" style="float:left;" >
                <a  href="<?php echo INSTALL_URL; ?>Items/import">
        ...
        if ($count > 0) {
            for ($i = 0; $i < $count; $i++) {
              ...
              <tr class="<?php echo $i % 2 === 0 ? 'odd' : 'even'; ?>">
                   ...
                   <td><a class="btn btn-success btn-sm" href="<?php echo INSTALL_URL; ?>Items/edit/<?php echo $tpl['Itemsarr'][$i]['id']; ?>" rev="<?php echo $tpl['Itemsarr'][$i]['id']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
                   <td><a class="btn btn-danger btn-sm icon-delete" rev="<?php echo $tpl['Itemsarr'][$i]['id']; ?>" href="<?php echo INSTALL_URL; ?>Items/delete/<?php echo $tpl['Itemsarr'][$i]['id']; ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
                </tr>
                <?php
            }
        } else {
            ...
            <td colspan="9">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo INSTALL_URL ?>Items/export"><?php echo __('export'); ?></a></li>
