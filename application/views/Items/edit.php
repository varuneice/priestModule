...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo INSTALL_URL; ?>Items/index"><?php echo __('edit'); ?></a></li>
...
<form id="edit_user" class="frm-class user-frm-class" action="<?php echo INSTALL_URL; ?>Items/edit" method="post" name="edit" enctype="multipart/form-data">
        ...
        <div class="padding-19 nav-tabs-custom left width_100">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <!-- <div class="quantity"> -->
                       <input id="count" type="number" class="form-control input-sm" name="count" value="<?php echo $tpl['Itemsarr']['count'] ?? ''; ?>" title="count" placeholder="count" min="1" step="1" value="1">
                    <!-- </div> -->
                </div>
                <div class="form-group">
