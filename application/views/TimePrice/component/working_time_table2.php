 <!-- <style>
     #working-time-table-id > thead > tr > th:nth-child(9){
        display:none;
    } 
   #working-time-table-id > tbody > tr:nth-child(1) > td:nth-child(9){
        display:none;   
    }
    #working-time-table-id > tbody > tr:nth-child(2) > td:nth-child(9){
        display:none;   
    }
    #working-time-table-id > tbody > tr:nth-child(3) > td:nth-child(9){
        display:none;   
    }
    #working-time-table-id > tbody > tr:nth-child(4) > td:nth-child(9){
        display:none;   
    }
    #working-time-table-id > tbody > tr:nth-child(5) > td:nth-child(9){
        display:none;   
    }
    #working-time-table-id > tbody > tr:nth-child(6) > td:nth-child(9){
        display:none;   
    }
    #working-time-table-id > tbody > tr:nth-child(7) > td:nth-child(9){
        display:none;   
    }  
...
<?php if (!empty($tpl['calendars'])) { ?>
    ...
    <strong style="margin-left: 50rem;"> <label for="puja_location">Select Puja Location:</label></strong>
   
   

<!-- <form id="locationForm" method="POST">
<input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>"> -->
    <!-- <select name="puja_location" id="puja_location" class="form-control">
        <option value="">-- Select Location --</option>
        <option value="1">Inside Durgabari</option>
        <option value="2">Outside Durgabari</option>
        <option value="3">Whole Day (Out of Town)</option>
    </select> -->
<!-- </form> -->

<form action="" method="POST">
<input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>">
    <select name="puja_location" id="puja_location" class="form-control" onchange="this.form.submit()">
        <option value="">-- Select Location --</option>
        <option value="1" <?php if(isset($_POST['puja_location']) && $_POST['puja_location'] == '1') echo 'selected'; ?>>Inside Durgabari</option>
        <option value="2" <?php if(isset($_POST['puja_location']) && $_POST['puja_location'] == '2') echo 'selected'; ?>>Outside Durgabari</option>
        <option value="3" <?php if(isset($_POST['puja_location']) && $_POST['puja_location'] == '3') echo 'selected'; ?>>Whole Day (Out of Town)</option>
    </select>
</form>
    ...
    <table id="working-time-table-id" class="table table-responsive table-hover table-bordered" cellpadding="0" cellspacing="0" >
        <thead>
            <tr>
                ...
                <th style = "display:none;"><?php echo __('price_per_slot'); ?></th>
