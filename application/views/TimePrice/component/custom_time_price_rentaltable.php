...
<?php if (!empty($tpl['arr'])) { ?>
    <table id="working-time-table-id11" class="table table-responsive table-hover table-bordered" cellpadding="0" cellspacing="0" >
        <thead>
            <tr>
...
<?php } ?>
<script>
    if ($('#working-time-table-id11').length > 0) {
            $('#working-time-table-id11').dataTable({
                "aoColumnDefs": [
