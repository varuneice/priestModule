...
<input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>">
        <div class="padding-19 nav-tabs-custom left width_100">
            <fieldset>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-danger1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <h4 class="font-weight-normal mb-3" style="font-size:21px; color:white;"><b>MID
                                        &nbsp;</b><i class="mdi mdi-pen mdi-24px float-right"></i>
                                </h4>
                                <h2 class="mb-5">
                                    <input readonly id="MID" class="form-control mb-5" type="text" name="MID" size="12"
                                        value="<?php echo $tpl['volarr']['MID'] ?? ''; ?>" title="MID" placeholder="MID">
                                </h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-danger1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                <img src="<?= INSTALL_URL ?>images/dashboard/circle.svg"
                                    class="card-img-absolute1" alt="circle-image" />
                                <h4 class="font-weight-normal mb-3" style="font-size:21px; color:white;"><b>First Name
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                <img src="<?= INSTALL_URL ?>images/dashboard/circle.svg"
                                    class="card-img-absolute1" alt="circle-image" />
                                <h4 class="font-weight-normal mb-3" style="font-size: 21px; color:white;"><b>Core
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-info1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                <img src="<?= INSTALL_URL ?>images/dashboard/circle.svg"
                                    class="card-img-absolute1" alt="circle-image" />
                                <h4 class="font-weight-normal mb-3" style="font-size: 21px; color:white;"><b>Parking
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-success1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                <img src="<?= INSTALL_URL ?>images/dashboard/circle.svg"
                                    class="card-img-absolute1" alt="circle-image" />
                                <h4 class="font-weight-normal mb-3" style="font-size: 21px; color:white;"><b>Paid
                                        Parking</b><i class="mdi mdi-diamond mdi-24px float-right"></i>
                                </h4>
                                <h2 class="mb-5"> <input readonly id="registration_status" class="form-control input-sm"
                                        type="text" name="Sponsor_Parking" size="25"
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-success1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                <img src="<?= INSTALL_URL ?>images/dashboard/circle.svg"
                                    class="card-img-absolute1" alt="circle-image" />
                                <h4 class="font-weight-normal mb-3" style="font-size:21px; color:white;"><b>Parking Lot
                                ...
                                <h2 class="mb-5">
                                    ...
                                    <select required="true" id="parking_assigned" onchange="decalassigned(this.id)"
                                        style="width: 100%!important; height: 36px!important;"
                                ...
                                <?php
                                    ...
                                    ?>
                                <h2>
                                    <input readonly id="parking_assigned" required="true" class="form-control input-sm"
                                        type="text" name="Parking_AreaAssigned" size="25"
                                        value="<?php echo $tpl['volarr']['Parking_AreaAssigned'] ?? ''; ?>"
                                        title="parking Assigned" placeholder="parking Assigned">
                                </h2>
                                <?php
                            } ?>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-success1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                <img src="<?= INSTALL_URL ?>images/dashboard/circle.svg"
                                    class="card-img-absolute1" alt="circle-image" />
                                <h4 class="font-weight-normal mb-3" style="font-size:21px; color:white;"><b>Decal
                                        Assigned</b><i class="mdi mdi-diamond mdi-24px float-right"></i>
                                </h4>
                                <?php if ($this->controller->isParkingAdmin() || $this->controller->isAdmin())  { ?>
                                <h2 class="mb-5"> <input id="Decal" class="form-control input-sm" type="text"
                                        name="Decal" size="25" value="<?php echo $tpl['volarr']['Decal'] ?? ''; ?>"
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-primary1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                <img src="<?= INSTALL_URL ?>images/dashboard/circle.svg"
                                    class="card-img-absolute1" alt="circle-image" />
                                <h4 style="color:white;" class="font-weight-normal mb-2"><b>FULL Name
                                        When Authorized To Collect</b><i
                                        class="mdi mdi-diamond mdi-24px float-right"></i>
                                </h4>
                                <h5 class="mb-5"> <input id="Full_Name" class="form-control input-sm" type="text"
                                        name="Name_Authorized" size="25"
                                        value="<?php echo $tpl['volarr']['Name_Authorized'] ?? ''; ?>" title="Full Name"
                                        placeholder="Full Name "></h5>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-primary1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                <img src="<?= INSTALL_URL ?>images/dashboard/circle.svg"
                                    class="card-img-absolute1" alt="circle-image" />
                                <h4 style="font-size:27px; color:white;"><b> Date &nbsp;<i
                                        class="fa fa-calendar mdi-24px float-right"></i> </b></h4>
                                <?php if ($this->controller->isParkingAdmin() || $this->controller->isAdmin())  { ?>
                                <h2 class="mb-5">
                                    <input type="date" id="date" name="Date" max="<?php echo date('Y-m-d'); ?>"
                                        value="<?php echo $tpl['volarr']['Date'] ?? ''; ?>" title="Date">
                                </h2>
                                <?php
                                } else {
                                    ?>

                                <h2 class="mb-5"> <input required="true" type="date" id="date" name="Date"
                                        max="<?php echo date('Y-m-d'); ?>" value="<?php echo $tpl['volarr']['Date'] ?? ''; ?>"
                                        title="Date"></h2>
                                <?php
                            } ?>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-primary1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                <h4 style="font-size:23px; color:white;"><b>Signature</b></h4>
                                <button id="clear" style="font-size:15px;margin-bottom:3px; ">Clear</button>
                                <button id="disable" style="font-size:15px; margin-bottom:3px;">Disable</button>
                                <img src="<?= INSTALL_URL ?>images/dashboard/circle.svg"
                                    class="card-img-absolute1" alt="circle-image" />
                                <!-- <h4 class="font-weight-normal mb-3">Signature<i class="mdi mdi-diamond mdi-24px float-right"></i> -->
                                <!-- <div class ="col-lg-12 col-md-12 col-sm-12 col-xs-12">  -->
                                <div style="width:320px!important;height:74px!important; " id="sig"> </div>
                                <div class=" stretch-card1 grid-margin1">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 stretch-card1 grid-margin1">
                        <div class="card1 bg-gradient-primary1 card-img-holder1 text-white1">
                            <div class="card-body1">
                                ...
                                <input type="hidden" name="Volunteer_Name"
                                    value="<?php echo $tpl['volarr']['Volunteer_Name'] ?? ''; ?>" />
                                ...
                                <!-- <div class="row"> -->
                                    ...
                                    <button class="col-lg-6 col-md-6 col-sm-6 col-xs-6 btn btn-primary"
                                        style="width:150px!important;height:139px;font-size:27px;" id="submits"
                                ...
                                ?>
                                    <button class="col-lg-6 col-md-6 col-sm-6 col-xs-6 btn btn-primary" disabled=""
                                        style="width:150px!important;height:139px;font-size:27px;" id="submit"
                                        autocomplete="off" value="<?php echo __('save'); ?>" name="submit" tabindex="9"
                                        type="submit"><i
                                            class="fa fa-fw fa-save"></i><b><?php echo _('Save') ?></b></button>
                                    <?php
                                    ...
                                    <button class="col-lg-6 col-md-6 col-sm-6 col-xs-6 btn btn-primary"
                                        style="float:right!important;width:150px!important;height:139px;font-size:27px;"
                                        id="clean" style="font-size:17px; margin-bottom: 3px;"><b>Clear</b></button>
                                <!-- </div> -->
                            </div>
                        </div>
                    </div>
