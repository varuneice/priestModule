...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo INSTALL_URL; ?>Items/index"><?php echo __('Items'); ?></a></li>
        <li class="active"><?php echo __('Items'); ?></li>
    </ol>
</section>
<?php
...
<section class="content left width_100">
    <form id="new_user" class="frm-class user-frm-class" action="<?php echo INSTALL_URL; ?>RentalBooking/itemscreate" method="post" name="create" enctype="multipart/form-data">
            ...
            <fieldset>
               ...
               <span style="position: relative;padding: 3px;left: 55px; border: 1px solid black;background-color: lightgray">&#36</span>
                ...
                <fieldset>
                    ...
                    <input type="hidden" name="itemscreate" value="1" /> 
