<section class="content-header">
    <h1>
        <?php echo __('Rental service'); ?>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo INSTALL_URL; ?>"><i class="fa fa-dashboard"></i> <?php echo __('home'); ?></a></li>
        <li class="active"><?php echo __('Rental service'); ?></li>
    </ol>
</section>
<?php
...
<section class="content">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs" >
            <li class="active">
                <a data-toggle="tab" href="#tab_1"><?php echo __('All Booking'); ?></a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#tab_2"><?php echo __('Rental Amount'); ?></a>
            </li>
            <li class="">
                <a data-toggle="tab" href="#tab_3"><?php echo __('Rental Advance Amount'); ?></a>
            </li>
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <div id="example1_wrapper" class="dataTables_wrapper form-inline" role="grid">
                            <form name="table-frm" id="table-frm-id" method="post" action="<?php echo INSTALL_URL; ?>?controller=RentalBooking&action=deleteSelected">
               ...
               <div class="box">
                    <div class="box-body table-responsive">
                        <div id="tab_2_wrapper" class="dataTables_wrapper form-inline" role="grid">
                            <form name="table-frm" id="table-frm-2-id" method="post" action="<?php echo INSTALL_URL; ?>?controller=RentalBooking&action=deleteSelected">
<input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>">
                                <?php
                                require 'component/booking_1_table.php';
                                ?>
                            </form>
                        </div>
                    </div>
...
<input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?? '' ?>">
                                <?php
                                require 'component/advanceamount.php';
                                ?>
                            </form>
                        </div>
                    </div>
...
<div id="dialogDelete" title="<?php echo htmlspecialchars(__('Rental Booking')); ?>" style="display:none">
