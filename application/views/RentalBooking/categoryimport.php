<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo INSTALL_URL; ?>RentalBooking/categoryitemindex"><?php echo __('Category'); ?></a></li>
        ...
        <div class="col-md-12 ui-sortable">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form id="import-frm-id" class="frm-class import-frm-class" action="<?php echo INSTALL_URL; ?>RentalBooking/categoryimport" method="post" name="import-frm" enctype="multipart/form-data">
