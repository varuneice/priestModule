    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = mb_convert_encoding(strtr(mb_convert_encoding($this->file_dst_name_body, 'ISO-8859-1', 'UTF-8'), mb_convert_encoding('ŠŽšžŸÀÁÂÃÄÅÇÈÉÊËÌÍÎÏÑÒÓÔÕÖØÙÚÛÜÝàáâãäåçèéêëìíîïñòóôõöøùúûüýÿ', 'ISO-8859-1', 'UTF-8'), 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy'), 'UTF-8', 'ISO-8859-1');
