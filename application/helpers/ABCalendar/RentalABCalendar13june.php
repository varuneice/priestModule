...
#gz-abc-calendar-container-2 > div.gzABCalCellLegend > div:nth-child(2){display: none;}
#gz-abc-calendar-container-2 > div.gzABCalCellLegend > div:nth-child(5){display: none;}
</style> 
...
class RentalABCalendar extends App {
    ...
    function getLegend() {
        ...
        $html = '<div class="gzABCalCellLegend" cellspacing="1" cellpadding="2">
                    <div class="gzABCalCellLabel">Fully Available<div class="gzABCalCellColor gzABCalColorAvil">&nbsp;</div></div>
                    ...
                    <div class="gzABCalCellLabel">' . __('full_booked') . '<div class="gzABCalCellColor gzABCalColorReserved">&nbsp;</div></div>
                     <div class="gzABCalCellLabel">Facility is Closed (Special events)<div class="gzABCalCellColor gzABCalColorDayEvent">&nbsp;</div></div>
                    <div class="gzABCalCellLabel">' . __('special_event') . '<div class="gzABCalCellColor gzABCalColorDayEvent">&nbsp;</div></div>
                     <div class="gzABCalCellLabel">Partially Available<div class="gzABCalCellColor gzABCalColorPartial2">&nbsp;</div></div>';
